            ...
            <tr>
                ...
                <td>
                    <select class="form-control text-center"
                        ...
                        <option class="text-center" @if ($key->status == 'waiting') selected @endif value="waiting">قيد
                            الانتظار</option>
                        <option class="text-center" @if ($key->status == 'under_examination') selected @endif
                            value="under_examination">تحت الفحص</option>
                        <option class="text-center" @if ($key->status == 'done') selected @endif value="done">جاهز
                        </option>
                ...
                <td>
                    <a href="{{ route('reception.delete', ['id' => $key->id]) }}" class="btn btn-sm btn-danger"><span
                            class="fa fa-trash"></a>
                </td>
            </tr>
        @endforeach
