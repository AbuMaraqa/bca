                ...
                <div class="card-body">
                    <div class="row">
                        <form action="{{ route('program.instructions.update') }}" method="post">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="input-group input-group-outline my-3">
                                        <input id="instructions_name" required name="instructions_name"
                                            value="{{ $data->instructions_name }}" type="text"
                                            placeholder="اسم التعليمات" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                            ...
                            <input type="hidden" value="{{ $data->instructions_note }}" name="instructions_note"
                                id="instructions_note">
